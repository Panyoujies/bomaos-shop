...
CREATE TABLE `sys_pays` (
  ...
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间',
  `is_mobile` int(1) DEFAULT NULL COMMENT '移动端',
  `is_pc` int(1) DEFAULT NULL COMMENT 'pc端',
  PRIMARY KEY (`id`)
